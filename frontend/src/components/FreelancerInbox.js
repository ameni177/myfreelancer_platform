...
const FreelancerInbox = () => {
  ...
  const FreelancerName = localStorage.getItem("Name");
  ...
  const fetchInboxMessages = async () => {
    try {
      const response = await axios.get(`http://${backendUrl}:3001/inbox/freelancer-messages`, {
          ...
          {selectedMessage && (
            <>
              ...
              <Typography variant="body1">
                <strong>From:</strong> {selectedMessage.company_name}
              </Typography>
              <Typography variant="body1" sx={{ mt: 2 }}>
